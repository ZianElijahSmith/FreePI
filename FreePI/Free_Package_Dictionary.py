...
# path on local machine for testing
# will need to be changed to server path later

path_to_file = '/home/gnunix/FreePI/FreePI/tests/test.json'
...
def write_dictionary_to_json(dictionary, path_to_file):
    json_object = json.dumps(dictionary, indent=4)

    with open(path_to_file, "w") as file_object:
        for each in json_object:
            file_object.writelines(each)
